    ...
    const mockPosts: BlogPost[] = [
      {
        ...
        body: '# Preparing Your HVAC System for Edmonton\'s Harsh Winters\n\nEdmonton winters are no joke...',
        published: true
      },
      {
        ...
        body: '# Best Energy-Efficient Heating Solutions for Alberta Homes\n\nWith Alberta\'s cold winters...',
        published: true
      }
    ];
