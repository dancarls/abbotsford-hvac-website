...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'About Us | Abbotsford HVAC',
    description: 'Learn about Abbotsford HVAC. We are a locally-owned heating and cooling company serving the Fraser Valley with over 15 years of industry experience.',
    images: ['https://abbotsfordhvac.ca/og-about.jpg']
  }
};
...
export default function AboutPage() {
  const schemaData = {
    ...
    "mainEntity": {
      ...
      "description": "Founded in 2009, Abbotsford HVAC is a family-owned business providing reliable, professional heating and cooling services to the local community in the Fraser Valley."
    }
  };
      ...
      <section className="py-20 bg-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-xl text-blue-100 mb-10 leading-relaxed">
            Our expert support team is standing by 24/7 to help you with troubleshooting, quotes, or scheduling.
          </p>
