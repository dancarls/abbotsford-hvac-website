      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Work with Abbotsford's HVAC Experts?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Experience the difference that professional, reliable HVAC service makes for your home or business.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              ...
              className="bg-green-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-600 transition-colors cursor-pointer whitespace-nowrap"
            >
              Call (604) 555-0123
            </a>
          </div>
